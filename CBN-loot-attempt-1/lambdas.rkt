...
;;; (define (lambdas-e e env)
;;;   (match e
;;;     [(Prim1 p e)        (lambdas-e e env)]
;;;     [(Prim2 p e1 e2)    (append (lambdas-e e1 env) (lambdas-e e2 env))]
;;;     [(Prim3 p e1 e2 e3) (append (lambdas-e e1 env) (lambdas-e e2 env) (lambdas-e e3 env))]
;;;     [(If e1 e2 e3)      (append (lambdas-e e1 env) (lambdas-e e2 env) (lambdas-e e3 env))]
;;;     [(Begin e1 e2)      (append (lambdas-e e1 env) (lambdas-e e2 env))]
;;;     [(Let x e1 e2)      (append (lambdas-e e1 env) (lambdas-e e2 (cons (cons x e1) env)))]
;;;     [(App e1 es)        (append (lambdas-e e1 env) (append-map lambdas-e es env))]
;;;     [(Lam f xs e1)      (cons (cons (Lam f xs e1) env) (lambdas-e e1 env))]
;;;     [(Match e ps es)    (append (lambdas-e e env) (append-map lambdas-e es env))]
;;;     [_                  '()]))
